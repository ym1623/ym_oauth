...
//$_SESSION["appid"]    = 100269916; 
//
////申请到的appkey
////$_SESSION["appkey"]   = "yourappkey"; 
//$_SESSION["appkey"]   = "50da9ab6d0f8ebb8f6d6a6700a73cc4a"; 
//
////QQ登录成功后跳转的地址,请确保地址真实可用，否则会导致登录失败。
////$_SESSION["callback"] = "http://your domain/oauth/get_access_token.php"; 
//$_SESSION["callback"] = "http://3.ymsite.sinaapp.com/oauth/qq_callback.php";
//
////QQ授权api接口.按需调用
...
$config['appid'] = ;
$config["appkey"]   = ""; 
$config["callback"] = "http://3.ymsite.sinaapp.com/qq/oauth/qq_callback.php";
$config["scope"] = "get_user_info,add_share,list_album,add_album,upload_pic,add_topic,add_one_blog,add_weibo";
$access_token = '';
$state = '';
