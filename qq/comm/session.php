...
{
    //mysql的主机地址
    //const db_host = SAE_MYSQL_HOST_S.':'.SAE_MYSQL_PORT; //需要第三方指定ip地址 

    //数据库用户名
    const db_user = SAE_MYSQL_USER;   //需要第三方指定自己的用户名

    //数据库密码
    const db_pwd = SAE_MYSQL_PASS; //需要第三方指定自己的库据库密码

    //数据库
    const db_name = SAE_MYSQL_DB;      //需要第三方指定数据库
    ...
    function open($savePath, $sessName) 
    {
        ...
        $db_handle = @mysql_connect(SAE_MYSQL_HOST_S.':'.SAE_MYSQL_PORT, self::db_user, self::db_pwd);
