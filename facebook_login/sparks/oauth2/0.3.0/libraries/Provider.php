 ...
 */
require_once dirname(__file__) . '/Facebook_oauth.php';
abstract class OAuth2_Provider
{
	...
	public function __construct(array $options = array())
	{
		...
		$this->facebook_oauth = new Facebook_oauth($facebook_config);
	...
	public function access($code, $options = array())
	{
		...
		switch ($this->method)
		{
			case 'GET':
				...
				$return = array('access_token' => $this->facebook_oauth->getAccessToken());
